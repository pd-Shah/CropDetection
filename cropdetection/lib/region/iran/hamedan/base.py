from remotesensingmathematica.rs_mathematica import RSMathematicaIranHamedan
from index.index import IndexIranHamedan


class HamedanBase(IndexIranHamedan, RSMathematicaIranHamedan):
